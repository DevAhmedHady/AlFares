...
export class WorkersComponent {
  ...
  readonly workerForm = signal({ name: '', jobTitle: '', isActive: true }); readonly txn = signal({ amount: 0, date: new Date().toISOString().slice(0, 10), notes: '', expenseTypeId: '' }); readonly toIso = toIso; readonly txnDateModel = computed(() => toDate(this.txn().date));
