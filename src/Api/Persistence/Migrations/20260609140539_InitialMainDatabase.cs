...
namespace Api.Persistence.Migrations
{
    ...
    public partial class InitialMainDatabase : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema(name: "workers");

            migrationBuilder.EnsureSchema(name: "cars");
            ...
            migrationBuilder.EnsureSchema(name: "revenues");

            migrationBuilder.EnsureSchema(name: "todos");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlateNumber = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatasourceKey = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: false
                    ),
                    XField = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: false
                    ),
                    YField = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    contact_name = table.Column<string>(
                        type: "character varying(150)",
                        maxLength: 150,
                        nullable: false
                    ),
                    ...
                    AccountBalance = table.Column<decimal>(
                        type: "numeric(18,2)",
                        precision: 18,
                        scale: 2,
                        nullable: false
                    ),
                    ActivityLevel = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    replaced_by_hash = table.Column<string>(
                        type: "character varying(128)",
                        maxLength: 128,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_tenant_permissions",
                        x => new { x.tenant_role_id, x.permission_id }
                    );
                }
            );
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_tenant_user_roles",
                        x => new { x.tenant_user_id, x.tenant_role_id }
                    );
                }
            );
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    joined_at_utc = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                },
        ...
        {
            migrationBuilder.DropTable(name: "advances", schema: "workers");

            migrationBuilder.DropTable(name: "cars", schema: "cars");

            migrationBuilder.DropTable(name: "chart_definitions", schema: "dashboard");

            migrationBuilder.DropTable(name: "clients", schema: "clients");
            ...
            migrationBuilder.DropTable(name: "revenues", schema: "revenues");

            migrationBuilder.DropTable(name: "role_permissions", schema: "identity");

            migrationBuilder.DropTable(name: "roles", schema: "identity");

            migrationBuilder.DropTable(name: "settlements", schema: "workers");

            migrationBuilder.DropTable(name: "tenant_permissions", schema: "identity");

            migrationBuilder.DropTable(name: "tenant_roles", schema: "identity");

            migrationBuilder.DropTable(name: "tenant_user_roles", schema: "identity");

            migrationBuilder.DropTable(name: "tenant_users", schema: "identity");

            migrationBuilder.DropTable(name: "tenants", schema: "identity");

            migrationBuilder.DropTable(name: "todo_items", schema: "todos");

            migrationBuilder.DropTable(name: "users", schema: "identity");

            migrationBuilder.DropTable(name: "workers", schema: "workers");

            migrationBuilder.DropTable(name: "expense_types", schema: "expenses");

            migrationBuilder.DropTable(name: "revenue_types", schema: "revenues");
        }
    }
}
