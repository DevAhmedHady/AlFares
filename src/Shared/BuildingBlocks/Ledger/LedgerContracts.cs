...
public enum OwnerType { General = 0, Client = 1, OwnedCar = 2, RentedCar = 3, Worker = 4 }

/// <summary>Identifies the financial direction of a ledger entry.</summary>
public enum LedgerKind { Expense = 0, Revenue = 1 }

/// <summary>Cross-module ledger read model.</summary>
public sealed record LedgerEntry(Guid Id, LedgerKind Kind, OwnerType OwnerType, Guid? OwnerId, string Description, decimal Amount, DateOnly Date);
