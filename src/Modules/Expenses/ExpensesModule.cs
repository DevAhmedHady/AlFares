...
public sealed class ExpensesModule:IModule
{
    ...
    /// <inheritdoc/>
    public void Register(IServiceCollection services,IConfiguration config){ArgumentNullException.ThrowIfNull(services);ArgumentNullException.ThrowIfNull(config);}
    /// <inheritdoc/>
